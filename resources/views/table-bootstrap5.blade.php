        ...
        <div class="d-block d-md-none mt-3">
                ...
                <div class="mb-3">
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-funnel me-2" viewBox="0 0 16 16">
                            <path
            ...
            <div class="mb-3">
                <div class="row g-2 mb-3">
                    <div class="col-8">
                        <select wire:model.live="sortBy" class="form-select form-select-sm shadow-sm">
                    ...
                    <div class="col-4">
                        <select wire:model.live="sortDirection" class="form-select form-select-sm shadow-sm">
            ...
            @forelse ($data as $index => $item)
                <div wire:key="{{ uniqid('card-') }}" class="card mb-3 shadow-sm">
                    <div class="card-body p-3">
                        ...
                        @foreach ($regularColumns as $col)
                            ...
                            <div class="border-bottom py-2">
                                <label class="fw-bold text-muted small text-uppercase mb-1 d-block"
                    ...
                    @if ($actionColumn)
                        ...
                        @endphp
                        <div
                            class="card-footer bg-light p-3 d-flex flex-wrap justify-content-end gap-2 {!! str_replace("class='", '', str_replace("'", '', $cell_class)) !!}">
