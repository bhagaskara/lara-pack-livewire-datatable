<div>
    ...
    <div class="row justify-content-between mb-3">
        <div class="col-auto mb-3 d-flex align-items-center {{ $showSelectPageLength ? '' : 'd-none' }}">
            <select wire:model.change="length" class="form-select form-select-sm">
        ...
        <div class="col-sm-6 mb-3 d-flex align-items-center {{ $showKeywordFilter ? '' : 'd-none' }}">
